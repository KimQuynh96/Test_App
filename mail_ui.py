...
class  CheckBox:
    ...
    def CheckFolders():
        folder_dict = {
            ...
            "timecard": {
                "value": timecard.get(),
                "button": timecard_checkbox
            },
            "vacation": {
                "value": vacation.get(),
                "button": vacation_checkbox
            },
            "postmaster": {
                "value": postmaster.get(),
                "button": postmaster_checkbox
            },
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas.create_window(title_x,Distance(start_y,0),height=height , anchor="nw", window = domain_1 )
        ...
        canvas.create_window(content_x, Distance(start_y,0),height=height, anchor="nw", window=domain_value)
        ...
        canvas.create_window(title_x, Distance(start_y,1), anchor="nw", window=user_id,height=height)
        ...
        canvas.create_window(content_x, Distance(start_y,1), anchor="nw", window=id_value,height=height)
        ...
        canvas.create_window(title_x, Distance(start_y,2), anchor="nw", window=uer_password,height=height)
        ...
        canvas.create_window(content_x, Distance(start_y,2), anchor="nw", window=pw_value,height=height)
        ...
        canvas.create_window(title_x, Distance(start_y,3), anchor="nw", window=uer_password,height=height)
        ...
        canvas.create_window(content_x, Distance(start_y,3), anchor="nw", window=em_value,height=height)
        
        
        # Menu
        global all_checkbox, mail_checkbox, board_checkbox, contact_checkbox
        ...
        canvas.create_window(title_x, Distance(start_y,5), anchor="nw", window=menu_label)

        # Folder row1 #
        all_checkbox = tk.Checkbutton(canvas, text="All", var=all_folders, command = CheckBox.CheckboxAll)
        canvas.create_window(content_x, Distance(start_y,5), anchor="nw", window=all_checkbox)

        mail_checkbox = tk.Checkbutton(canvas, text="Mail", var=mail, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 100, Distance(start_y,5), anchor="nw", window=mail_checkbox)

        board_checkbox = tk.Checkbutton(canvas, text="Board", var=board, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 200, Distance(start_y,5), anchor="nw", window=board_checkbox)
        
        contact_checkbox = tk.Checkbutton(canvas, text="Contact", var=contact, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 300, Distance(start_y,5), anchor="nw", window=contact_checkbox)

        
        # Folder row2 #
        approval_checkbox = tk.Checkbutton(canvas, text="Approval", var=approval, command = CheckBox.CheckFolders)
        canvas.create_window(content_x, Distance(start_y,6), anchor="nw", window=approval_checkbox)

        circular_checkbox = tk.Checkbutton(canvas, text="Circular", var=circular, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 100, Distance(start_y,6), anchor="nw", window=circular_checkbox)

        todo_checkbox = tk.Checkbutton(canvas, text="ToDo", var=todo, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 200, Distance(start_y,6), anchor="nw", window=todo_checkbox)
        
        archive_checkbox = tk.Checkbutton(canvas, text="Archive", var=archive, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 300, Distance(start_y,6), anchor="nw", window=archive_checkbox)

        
        # Folder row3 #
        
        task_checkbox = tk.Checkbutton(canvas, text="Task", var=task, command = CheckBox.CheckFolders)
        canvas.create_window(content_x , Distance(start_y,7), anchor="nw", window=task_checkbox)
        
        project_checkbox = tk.Checkbutton(canvas, text="Project", var=project, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 100, Distance(start_y,7), anchor="nw", window=project_checkbox)

        resource_checkbox = tk.Checkbutton(canvas, text="Resource", var=resource, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 200, Distance(start_y,7), anchor="nw", window=resource_checkbox)
        
        expense_checkbox = tk.Checkbutton(canvas, text="Expense", var=expense, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 300, Distance(start_y,7), anchor="nw", window=expense_checkbox)
        
        # Folder row4 #
        
        calendar_checkbox = tk.Checkbutton(canvas, text="Calendar", var=calendar, command = CheckBox.CheckFolders)
        canvas.create_window(content_x , Distance(start_y,8), anchor="nw", window=calendar_checkbox)
        
        asset_checkbox = tk.Checkbutton(canvas, text="Asset", var=asset, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 100, Distance(start_y,8), anchor="nw", window=asset_checkbox)

        whisper_checkbox = tk.Checkbutton(canvas, text="Whisper", var=whisper, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 200, Distance(start_y,8), anchor="nw", window=whisper_checkbox)
        
        clouddisk_checkbox = tk.Checkbutton(canvas, text="Clouddisk", var=clouddisk, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 300, Distance(start_y,8), anchor="nw", window=clouddisk_checkbox)
        ...
        timecard_checkbox = tk.Checkbutton(canvas, text="Time Card", var=timecard, command = CheckBox.CheckFolders)
        canvas.create_window(content_x , Distance(start_y,9), anchor="nw", window=timecard_checkbox)
        
        vacation_checkbox = tk.Checkbutton(canvas, text="Vacation", var=vacation, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 100, Distance(start_y,9), anchor="nw", window=vacation_checkbox)

        postmaster_checkbox = tk.Checkbutton(canvas, text="Posmaster", var=postmaster, command = CheckBox.CheckFolders)
        canvas.create_window(content_x + 200, Distance(start_y,9), anchor="nw", window=postmaster_checkbox)
        ...
        inbox_checkbox = tk.Checkbutton(canvas, text="Inbox", var=inbox, command = CheckBox.CheckFolders)
        canvas.create_window(320, Distance(start_y,5), anchor="nw", window=inbox_checkbox)

        folders_checkbox = tk.Checkbutton(canvas, text="Folders", var=folders, command = CheckBox.CheckFolders)
        canvas.create_window(420, Distance(start_y,5), anchor="nw", window=folders_checkbox)

        
        # Folder row2 #
        shared_checkbox = tk.Checkbutton(canvas, text="Shared", var=shared, command = CheckBox.CheckFolders)
        canvas.create_window(content_x, Distance(start_y,6), anchor="nw", window=shared_checkbox)

        fetching_checkbox = tk.Checkbutton(canvas, text="Fetching", var=fetching, command = CheckBox.CheckFolders)
        canvas.create_window(320, Distance(start_y,6), anchor="nw", window=fetching_checkbox)

        spam_checkbox = tk.Checkbutton(canvas, text="Spam", var=spam, command = CheckBox.CheckFolders)
...
class Page1(tk.Frame):
    ...
    def Load_UI(self,Mail_List,controller)  :
        ...
        canvas.create_window(self.title_x,Distance(self.Start_Y,0),height=30 , anchor="nw", window=back )
        ...
        canvas.create_window(self.title_x, Distance(self.Start_Y,1), anchor="nw", window=Suspected)
...
class Page2(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas.create_window(title_x,Distance(Start_Y,0),height=height , anchor="nw", window=user_name )
